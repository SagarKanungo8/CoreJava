...
public class UserModel {
	 ...
	 * Get User Roles
	 * 
	 * @return List : User Role List o * @param bean
	...
	public static boolean changePassword(long id, String oldPassword, String newPassword)
		...
		/*
		 * HashMap<String, String> map = new HashMap<String, String>();
		 * map.put("login", ub.getLogin()); map.put("password",
		 * ub.getPassword()); map.put("firstName", ub.getFirstName());
		 * map.put("lastName", ub.getLastName());
		 * 
		 * String message = EmailBuilder.getChangePasswordMessage(map);
		 * 
		 * EmailMessage msg = new EmailMessage(); msg.setTo(ub.getLogin());
